...
![Version: 0.20.2](https://img.shields.io/badge/Version-0.20.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.20.2](https://img.shields.io/badge/AppVersion-0.20.2-informational?style=flat-square)
...
| infra.eventing.eventBusARN | string | `""` | Set to the ARN of the eventBus to set EVENTBUS_ARN in the application's environment. Should come from an SSM parameter. |
