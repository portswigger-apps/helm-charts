...
| s3Bucket.create | bool | `true` | Set to `true` to allow data insights access to the `s3Bucket` |
...
| redis.version | string | `7.2` | Options: 7.2 |
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| s3Bucket.enableDataInsights | bool | `false` |  |
