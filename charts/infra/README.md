...
| cloudfrontrouter.origins | object | `{}` | A map of custom origins to be used by path configurations |
| cloudfrontrouter.paths | list | `[]` | An ordered list of paths to direct to different origins |
| cloudfrontrouter.default | object | `{"cachePolicy":"CachingDisabled","cachePolicyId":"","targetOrigin":"default"}` | Values for the default origin config |
